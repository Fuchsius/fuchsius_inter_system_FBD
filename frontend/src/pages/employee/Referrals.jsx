          ...
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 border-t border-slate-200 flex gap-3 justify-end">
              ...
              <Button
                ...
                disabled={loading || !newUser.firstName || !newUser.lastName || !newUser.email || !newUser.phoneNumber || !newUser.university || !newUser.paidAmount || !newUser.address || !newUser.paySlip}
                className="bg-[#C4009A] text-white hover:bg-[#7E006C] border-none"
              >
                {loading ? (
                  <>
