...
import { Search, Clock, CheckCircle, CheckSquare, AlertCircle, Eye, X } from 'lucide-react';
        ...
        <div className="p-4 border-b border-slate-100 bg-slate-50/50 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:items-center">
            <Button
              variant="outline"
              size="sm"
              onClick={() => { setUserSearchTerm(''); setSelectedPriority('all'); setSelectedProject('all'); setFilterStatus('all'); setSelectedUser('all'); setUserSearch(''); }}
            >
              Clear
            </Button>
          </div>
