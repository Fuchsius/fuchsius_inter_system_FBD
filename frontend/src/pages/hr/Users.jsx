...
import {
  Users as UsersIcon, Download, Plus, MoreVertical, Search, X, UserPlus, Copy, Award, Edit, UserX, Upload, Trash2, Circle,
...
useEffect(() => {
  ...
  }, [filters.name, filters.role, filters.position, filters.status]);
  ...
  const clearFilters = () => {
    setFilters({ name: '', role: '', position: '', status: '' });
  };
          ...
          <div className="space-y-4">
            ...
            {Object.values(filters).some(value => value) && (
              <div className="flex flex-wrap items-center gap-2 text-sm text-slate-600 p-3 bg-slate-50 rounded-lg">
                ...
                <span className="text-fuchsia-600 font-medium ml-auto">{pagination.total || 0} results found</span>
              </div>
            )}
          </div>
        </div>
